...
const AddDocumentVerification = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await apiService.documentVerifications.create(submitData);
  ...
  return (
    <div className="add-document-verification">
      <div className="page-header">
        <h1 className="page-title">Add Document Verification</h1>
        <p className="page-subtitle">Create a new document verification record</p>
      </div>
